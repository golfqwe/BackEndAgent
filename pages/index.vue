              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex">
                    ...
                    <div class="text-primary ms-auto">
                      <i class="ri-bank-card-line font-size-24" />
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body border-top py-3">
                  <div class="text-truncate">
                    <span class="badge badge-soft-danger font-size-11"><i class="mdi mdi-menu-down" />
                      2.4% </span>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex">
                    ...
                    <div class="text-primary ms-auto">
                      <i class="ri-refund-fill font-size-24" />
                    </div>
                  </div>
                </div>
                <div class="card-body border-top py-3">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex">
                    ...
                    <div class="text-primary ms-auto">
                      <i class="ri-user-3-line font-size-24" />
                    </div>
                  </div>
                </div>
                <div class="card-body border-top py-3">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex">
                    ...
                    <div class="text-primary ms-auto">
                      <i class="ri-user-3-fill font-size-24" />
                    </div>
                  </div>
                </div>
                <div class="card-body border-top py-3">
...
export default {
  ...
  mounted () {
    setTimeout(() => {
      ...
      script.src = '/js/pages/dashboard_index.init.js'
